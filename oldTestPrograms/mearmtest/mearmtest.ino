...
void setup()   {
  ...
  ARM[1][0][0] = 90 + offset[1];
  ARM[1][0][1] = 150 + offset[1];
  ARM[1][1][0] = 122 + offset[1];
  ARM[1][1][1] = 152 + offset[1];
  ...
  ARM[2][0][0] = 180 + offset[2];
  ARM[2][0][1] = 65 + offset[2];
  ARM[2][1][0] = 180 + offset[2];
  ARM[2][1][1] = 140 + offset[2];
